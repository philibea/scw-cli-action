...
```yaml
    - name: Create a new instance
        uses: aphilibeaux/scw-cli-action@v2.3.1
        env:
...
```
aphilibeaux/scw-cli-action@v{M.m.p}-{a}
```
...
This action is heavily inspired from [jawher action](https://github.com/jawher/action-scw)
